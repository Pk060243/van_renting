                     ...
                     <div class="card card-transparent shadow-none d-flex justify-content-center mb-0 auth-card">
                        <div class="card-body">
                           <a href="dashboard/main.php" class="navbar-brand d-flex align-items-center mb-3">
                              ...
                              <!--logo End-->                              <h4 class="logo-title ms-3">Van Renting</h4>
                           </a>
                              ...
                              <div class="row">
                                 <div class="col-lg-12">
                                    <div class="form-group">
                                       <label for="inp-user" class="form-label">Username</label>
                                       <input type="text" class="form-control" id="inp-user" aria-describedby="inp-user" placeholder="User name">
                                    </div>
                                 </div>
                                 <div class="col-lg-12">
                                    <div class="form-group">
