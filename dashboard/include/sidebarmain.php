...
<aside class="sidebar sidebar-default navs-rounded-all">
    <div class="sidebar-header d-flex align-items-center justify-content-start">
        <a href="../dashboard/admin_main.php" class="navbar-brand">
            <!--Logo start-->
            ...
            <!--logo End-->
            <h4 class="logo-title">Van Renting</h4>
        </a>
    ...
    <div class="sidebar-body pt-0 data-scrollbar">
        <div class="sidebar-list">
            ...
            <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                ...
                <li class="nav-item">
                    <a class="nav-link" aria-current="page" href="../dashboard/admin_main.php">
                        <i class="icon">
                ...
                <li class="nav-item">
                    <a class="nav-link" data-bs-toggle="collapse" href="#manage_menu_set" role="button" aria-expanded="false" aria-controls="manage_menu_set">
                        <i class="icon">
                            <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <span class="item-name">การจัดการ</span>
                        <i class="right-icon">
                    ...
                    <ul class="sub-nav collapse" id="manage_menu_set" data-bs-parent="#sidebar-menu">
                        <li class="nav-item">
                            <a class="nav-link" href="../dashboard/admin_van.php">
                                <i class="icon">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="../dashboard/admin_driver.php">
                                <i class="icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                        <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="../dashboard/admin_price.php">
                                <i class="icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                        <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                    ...
                    <ul class="sub-nav collapse" id="horizontal-menu" data-bs-parent="#sidebar-menu">
                        <li class="nav-item">
                            <a class="nav-link" href="../dashboard/admin_van.php">
                                ...
                                <i class="sidenav-mini-icon"> H </i>
                                <span class="item-name"> รายงานออเดอร์ </span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="../dashboard/admin_report_sales.php">
                                <i class="icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                        <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                ...
                                <i class="sidenav-mini-icon"> H </i>
                                <span class="item-name"> รายงานยอดขาย </span>
                            </a>
                        </li>
                    </ul>
                </li>
